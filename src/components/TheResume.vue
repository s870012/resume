...
<template>
  <section id="resume" class="bg-gray">
    <div class="container py-5">
      <div class="row">
        <div class="col-10 mx-auto">
          <div class="text-align blockquote">
            <h2 class="fw-bold mb-3">自我介紹</h2>
            <div class="lh-lg mb-3">
              <h5 class="fw-bold">學歷：</h5>
              <div class="d-flex justify-content-between align-items-center">
                <p>國立臺灣海洋大學 運輸科學系碩士</p>
                <p class="text-black-50 fs-6">2014.09 - 2016.07</p>
              </div>
            </div>
            <div class="lh-lg mb-3">
              <h5 class="fw-bold">個人特質：</h5>
              <p>
                個性溫和、具親和力，<strong>擅長溝通與協調</strong>，能與同儕及同事維持良好互動，營造和諧工作氛圍。
              </p>
            </div>
            <div class="lh-lg mb-3">
              ...
              <p>
                <strong>樂於學習</strong
                >並不斷自我成長，積極學習前端知識拓展跨領域能力，始終保持對學習的渴望，相信「投資自己」是最有價值的選擇。
              </p>
            </div>
            <div class="lh-lg">
              ...
              <p>
                ...
                框架的核心概念與實作能力。學習期間，我<strong>完成一個React實戰作品、一個切版作品</strong>，也參與團隊合作開發專案，從需求溝通、UI
                規劃到功能開發與問題排解，<strong>完整經歷實際開發流程</strong>，為未來職場銜接打下了穩固的基礎。這段學習歷程不僅強化了我的技術能力，也讓我對於成為一名前端工程師充滿信心。
              </p>
            </div>
          </div>
        </div>
